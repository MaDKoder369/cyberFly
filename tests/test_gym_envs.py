"""Tests the API compatibility of all cyberFly Gymnasium Envs."""
...
from cyberFly.gym_envs import FlattenWaypointEnv

# waypoint envs
_WAYPOINT_ENV_CONFIGS = []
for env_name, angle_representation, sparse_reward in itertools.product(
    [
        "cyberFly/QuadX-Waypoints-v4",
        "cyberFly/QuadX-Pole-Waypoints-v4",
        "cyberFly/Fixedwing-Waypoints-v4",
    ],
    ["euler", "quaternion"],
    [True, False],
):
...
for env_name, angle_representation, sparse_reward in itertools.product(
    [
        "cyberFly/QuadX-Hover-v4",
        "cyberFly/QuadX-Pole-Balance-v4",
        "cyberFly/QuadX-Ball-In-Cup-v4",
        "cyberFly/Rocket-Landing-v4",
    ],
    ["euler", "quaternion"],
    [True, False],
):
