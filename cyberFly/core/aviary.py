"""The Aviary class, the core of how cyberFly handles UAVs in the PyBullet simulation environment."""
...
from cyberFly.core.abstractions import DroneClass, WindFieldClass
from cyberFly.core.drones import Fixedwing, QuadX, Rocket
...
class Aviary(bullet_client.BulletClient):
    """Aviary class, the core of how cyberFly handles UAVs in the PyBullet simulation environment.
