"""Base cyberFly Environment for the QuadX model using the Gymnasim API."""
...
from cyberFly.core.aviary import Aviary
from cyberFly.core.utils.compile_helpers import check_numpy


class QuadXBaseEnv(gymnasium.Env):
    """Base cyberFly Environment for the QuadX model using the Gymnasium API."""
