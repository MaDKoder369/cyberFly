...
import numpy as np
from cyberFly.core import Aviary
...
By default, cyberFly ships with three different drones, listed under the [drones](../core/drones) section.
These are:
...
For custom drones not shipped in cyberFly (such as the [`RocketBrick`](https://github.com/jjshoots/PyFlyt/tree/master/examples/core/custom_uavs)), you can call them into the `aviary` by setting custom `drone_type_mappings`, and then calling them using `drone_type`:
...
By default, cyberFly steps physics at 240 Hz - the default for a PyBullet environment.
...
```{eval-rst}
.. autoclass:: cyberFly.core.Aviary
```

### Attributes
```{eval-rst}
.. autoproperty:: cyberFly.core.Aviary.all_states

.. autoproperty:: cyberFly.core.Aviary.all_aux_states

.. property:: cyberFly.core.Aviary.drones

    A list of all drones that the Aviary is currently handling.

.. property:: cyberFly.core.Aviary.contact_array
...
### Methods
```{eval-rst}
.. autofunction:: cyberFly.core.Aviary.print_all_bodies

.. autofunction:: cyberFly.core.Aviary.reset
.. autofunction:: cyberFly.core.Aviary.register_all_new_bodies

.. autofunction:: cyberFly.core.Aviary.state
.. autofunction:: cyberFly.core.Aviary.aux_state

.. autofunction:: cyberFly.core.Aviary.set_armed
.. autofunction:: cyberFly.core.Aviary.set_mode
.. autofunction:: cyberFly.core.Aviary.set_setpoint
.. autofunction:: cyberFly.core.Aviary.set_all_setpoints

.. autofunction:: cyberFly.core.Aviary.step
```
