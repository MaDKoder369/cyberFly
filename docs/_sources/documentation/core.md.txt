...
The core API of cyberFly looks something like the following:
...
Loosely put, cyberFly has the following architecture:
...
cyberFly uses two reference frames, the ground frame (subscript `G`) and the body frame (subscript `B`), shown above.
