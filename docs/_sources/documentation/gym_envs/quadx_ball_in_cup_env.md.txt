...
env = gymnasium.make("cyberFly/QuadX-Ball-In-Cup-v3", render_mode="human")
...
```{eval-rst}
.. autoclass:: cyberFly.gym_envs.quadx_envs.quadx_ball_in_cup_env.QuadXBallInCupEnv
```
