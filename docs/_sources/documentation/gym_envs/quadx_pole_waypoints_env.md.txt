# `cyberFly/QuadX-Pole-Waypoints-v3`
...
env = gymnasium.make("cyberFly/QuadX-Pole-Waypoints-v3", render_mode="human")
...
```{eval-rst}
.. autoclass:: cyberFly.gym_envs.quadx_envs.quadx_pole_waypoints_env.QuadXPoleWaypointsEnv
```
