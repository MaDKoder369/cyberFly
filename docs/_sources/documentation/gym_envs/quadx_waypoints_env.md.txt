...
env = gymnasium.make("cyberFly/QuadX-Waypoints-v3", render_mode="human")
...
```{eval-rst}
.. autoclass:: cyberFly.gym_envs.quadx_envs.quadx_waypoints_env.QuadXWaypointsEnv
```
