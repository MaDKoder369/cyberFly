...
It is possible to install cyberFly using [`conda`](https://docs.conda.io/en/latest/), but YMMV.
...
2. Now, you can install `cyberFly` as usual:
    ```sh
    pip3 install wheel numpy
    pip3 install pyflyt
    ```
...
While this documentation provides a detailed overview of cyberFly, the examples can bring you 80% of the way to a fully fledged user in a couple hours.
