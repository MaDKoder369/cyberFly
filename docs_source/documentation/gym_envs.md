...
Natively, cyberFly provides various default [Gymnasium](https://gymnasium.farama.org/) environments for testing reinforcement learning algorithms.
...
env = gymnasium.make("cyberFly/QuadX-Hover-v2", render_mode="human")
obs = env.reset()
