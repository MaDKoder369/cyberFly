# `cyberFly/Fixedwing-Waypoints-v3`
...
env = gymnasium.make("cyberFly/Fixedwing-Waypoints-v3", render_mode="human")
...
```{eval-rst}
.. autoclass:: cyberFly.gym_envs.fixedwing_envs.fixedwing_waypoints_env.FixedwingWaypointsEnv
```
