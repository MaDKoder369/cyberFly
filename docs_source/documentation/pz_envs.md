...
For that reason, cyberFly provides various default [PettingZoo](https://pettingzoo.farama.org/) environments for testing reinforcement learning algorithms.
...
```python
from cyberFly.pz_envs import MAQuadXHoverEnv
