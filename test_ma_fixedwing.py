...
from cyberFly.marl_wrappers.selfplay import SelfPlayEnv
...
if __name__ == "__main__":
    ...
    env_ego = SelfPlayEnv(ma_env, train_agent_id=0, opp_policy=random_opp)
    model_ego = SAC(
        policy="MlpPolicy",
        env=env_ego,
        verbose=1,
    ...
    env_adv = SelfPlayEnv(ma_env, train_agent_id=1, opp_policy=random_opp)
    model_adv = SAC(
        policy="MlpPolicy",
        env=env_adv,
        verbose=1,
