# Unmanned Aerial Vehicle Multi-Agent Reinforcement Learning Library
This Library builds of the cyberFly UAV flight simulator with more additional multi-agent environments and example Reinforcement Learning strategies to compare new strategies to.
...
## Installation 
This repository does have a docker image however there are some issues when using the Gymnasium GUI.

## cyberFly
The original cyberFly repository is also still under development and all its documentation can be found here.
#### [View the documentation here!](https://jjshoots.github.io/PyFlyt/documentation.html)

```
@article{tai2023pyflyt,
  title={cyberFly--UAV Simulation Environments for Reinforcement Learning Research},
